...
public class ChargeTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString("TheLightbearer:ChargeTutorial");
    public static final String[] MSG = tutorialStrings.TEXT;
    public static final String[] LABEL = tutorialStrings.LABEL;

    private static final TextureRegion img1 = new TextureRegion(new Texture("TheLightbearer/images/tutorials/ChargeTutorial1.png"));
    //private static final TextureRegion img2 = new TextureRegion(new Texture("TheLightbearer/images/relics/TheTraveler.png"));
    //private static final TextureRegion img3 = new TextureRegion(new Texture("TheLightbearer/images/relics/SagirasShell.png"));
    ...
    //From Noelle's Hydrologist mod
    public ChargeTutorial() {
        ...
        AbstractDungeon.overlayMenu.proceedButton.setLabel(LABEL[1]); //0 = Next, 1 = Got it
    }
    @Override
    public void update() {
        if (screen.a != 0.8f) {
        ...
        if (AbstractDungeon.overlayMenu.proceedButton.isHovered && InputHelper.justClickedLeft
            ...
            if (currentSlot == -0) { //decrease this to add more tabs
    ...
    public static class ShowChargeTutorialPatch {
        public static void Postfix(AbstractPlayer __instance) {
            if (__instance instanceof LightbearerCharacter && !TheLightbearer.lightbearerConfig.getBool("Charge Tutorial Seen")) {
                if (AbstractDungeon.screen != AbstractDungeon.CurrentScreen.FTUE) {
                    TheLightbearer.lightbearerConfig.setBool("Charge Tutorial Seen", true);
                    try { TheLightbearer.lightbearerConfig.save(); } catch (IOException e) { e.printStackTrace(); }
                    AbstractDungeon.ftue = new ChargeTutorial();
                }
            }
        }
    }
