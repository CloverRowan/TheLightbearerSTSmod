...
import static TheLightbearer.TheLightbearer.characterPath;
import static TheLightbearer.TheLightbearer.makeID;

public class LightbearerCharacter extends CustomPlayer {
    //Stats
    ...
    public LightbearerCharacter() {
        super(NAMES[0], Enums.THE_LIGHTBEARER,
                ...
                new SpineAnimation("TheLightbearer/images/character/animation/skeleton.atlas", "TheLightbearer/images/character/animation/skeleton.json", 3f)); //Animation
    ...
    public AbstractPlayer newInstance() {
        ...
        return new LightbearerCharacter();
    }
