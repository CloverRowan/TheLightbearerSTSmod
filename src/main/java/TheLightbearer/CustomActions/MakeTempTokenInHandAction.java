...
public class MakeTempTokenInHandAction extends AbstractGameAction {
    private BaseCard c;
    private static final float PADDING;
    private boolean isOtherCardInCenter;
    private boolean sameUUID;

    public MakeTempTokenInHandAction(BaseCard card, boolean isOtherCardInCenter) {
    ...
    public MakeTempTokenInHandAction(BaseCard card) {
        this(card, 1);
    }

    public MakeTempTokenInHandAction(BaseCard card, int amount) {
        this.isOtherCardInCenter = true;
        this.sameUUID = false;
        UnlockTracker.markCardAsSeen(card.cardID);
        this.amount = amount;
    ...
    public MakeTempTokenInHandAction(BaseCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public MakeTempTokenInHandAction(BaseCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
